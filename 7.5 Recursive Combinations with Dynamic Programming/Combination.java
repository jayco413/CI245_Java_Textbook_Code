public class Combination {
    ...
    private enum ComputationType {
        FACTORIAL, RECURSIVE, DYNAMIC_RECURSIVE
    }
        ...
        try {
            switch (computationType) {
                ...
                case RECURSIVE:
                    ...
                    break;
                case DYNAMIC_RECURSIVE:
                    // -1 flags a cell that hasn't been calculated yet.
                    ...
                    System.out.println(combinationDynamicRecursive(n, k, dp));
                    break;
            }
    ...
    private static int combinationDynamicRecursive(int n, int k, int[][] dp) {
        // ADD YOUR CODE HERE
        return 0;
    }
}
